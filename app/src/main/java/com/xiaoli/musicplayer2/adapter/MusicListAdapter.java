package com.xiaoli.musicplayer2.adapter;
...
public class MusicListAdapter extends RecyclerView.Adapter<MusicListAdapter.InnerHolder>{
    ...
    List<com.xiaoli.musicplayer2.domain.MusicListInfo> mMusicListInfo = new ArrayList<com.xiaoli.musicplayer2.domain.MusicListInfo>();
    ...
    public void onBindViewHolder(@NonNull InnerHolder holder, int position) {
        com.xiaoli.musicplayer2.domain.MusicListInfo musicListInfo = mMusicListInfo.get(position);
