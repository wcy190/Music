...
import com.xiaoli.musicplayer2.api.Api;
import com.xiaoli.musicplayer2.control.Main;
import com.xiaoli.musicplayer2.control.Result;
import com.xiaoli.musicplayer2.domain.MusicInfo;
import com.xiaoli.musicplayer2.domain.MusicList;
import com.xiaoli.musicplayer2.domain.MusicUrl;
...
public class MenuList {
    ...
    public static List<com.xiaoli.musicplayer2.domain.MusicListInfo> sMusicListInfo;
    ...
    private void updateInfo() {
        ...
        sMusicListInfo = new ArrayList<com.xiaoli.musicplayer2.domain.MusicListInfo>();
        mNum = 0;
        for (int i = 0; i < sCount; i++) {
            com.xiaoli.musicplayer2.domain.MusicListInfo mMusicListInfo = new com.xiaoli.musicplayer2.domain.MusicListInfo();
