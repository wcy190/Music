package com.xiaoli.musicplayer2.presenter;
...
public class PlayerPresenter extends Binder implements IPlayerController {
    ...
    @Override
    public void start(String url,boolean isLike) {  //开始
        if (!isLike){
            stop();
            initMediaPlayer();
            try {
    ...
    public void pauseOrResume() {  //暂停
        ...
        mViewController.onPlayStateChange(sCurrentState);  //设置相应图片
    }
