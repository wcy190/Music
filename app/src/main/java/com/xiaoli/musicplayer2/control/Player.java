...
import com.xiaoli.musicplayer2.interfaces.IPlayerController;
import com.xiaoli.musicplayer2.interfaces.IPlayerViewController;
import com.xiaoli.musicplayer2.service.PlayService;
...
import static com.xiaoli.musicplayer2.interfaces.IPlayerController.PLAY_STATE_PAUSE;
import static com.xiaoli.musicplayer2.interfaces.IPlayerController.PLAY_STATE_START;
import static com.xiaoli.musicplayer2.interfaces.IPlayerController.PLAY_STATE_STOP;
...
public class Player extends AppCompatActivity {
    ...
    private com.xiaoli.musicplayer2.domain.MusicListInfo mMusicInfo;
    ...
    private void initEvent() {
        ...
        mList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new CRUD().listAdd(getApplicationContext(),mPosition);
            }
        });
